import { hasInjectionContext, getCurrentInstance, version, unref, inject, defineAsyncComponent, defineComponent, h, onUnmounted, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, onErrorCaptured, toRef, isRef, markRaw, Fragment, mergeProps, createApp, effectScope, reactive, useSSRContext, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, Text, isShallow, isReactive, toRaw, withCtx, toDisplayString as toDisplayString$1, triggerRef, watchEffect, createTextVNode, resolveComponent } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, h as createError$1, l as defu, m as sanitizeStatusCode, n as createHooks, o as getRequestHeaders, p as parse$1, q as getRequestHeader, r as destr, t as isEqual$1, v as setCookie, w as getCookie, x as deleteCookie } from '../nitro/node-server.mjs';
...
import { resetCount, createConfig, getNode, clearErrors, setErrors, submitForm, reset, createClasses, generateClassList, createMessage, error, createNode, warn as warn$2, watchRegistry, isNode, sugar, isDOM, isComponent as isComponent$1, isConditional, compile as compile$1 } from '@formkit/core';
import { cloneAny, extend, empty, has, eq, shallowClone, undefine, camel, kebab, nodeProps, only, except, oncePerTick, slugify, isObject as isObject$2, token, isPojo } from '@formkit/utils';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/404-eDjf-Gp2.mjs').then((m) => m.default || m)
  },
  {
    name: "404___en",
    path: "/en/404",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Animation-BTV76Vl1.mjs').then((m) => m.default || m)
  },
  {
    name: "Animation___en",
    path: "/en/Animation",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-aQqKnByg.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-slug___en",
    path: "/en/blog/:slug()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-i-GKGnJR.mjs').then((m) => m.default || m)
  },
  {
    name: "blog___en",
    path: "/en/blog",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/form-RfgTgL2P.mjs').then((m) => m.default || m)
  },
  {
    name: "form___en",
    path: "/en/form",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-HGphocJh.mjs').then((m) => m.default || m)
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/swiper-aRvs5swm.mjs').then((m) => m.default || m)
  },
  {
    name: "swiper___en",
    path: "/en/swiper",
...
const LazyNuxtIcon = defineAsyncComponent(() => import('./_nuxt/nuxt-icon-SxrQCwNu.mjs').then((r) => r.default));
  ...
  node.on("created", () => {
    ...
    node.context.handlers.openDropDown = (e) => {
      ...
      if (node.props.isopen) {
        ...
        (void 0).addEventListener("click", closeDropDown);
      } else {
        currentDom.classList.remove("active");
        (void 0).removeEventListener("click", closeDropDown);
      }
    };
...
const localeMessages = {
  "zh": [{ key: "../lang/zh/index.js", load: () => import(
    './_nuxt/index-6Lmkr5uJ.mjs'
    /* webpackChunkName: "locale__Volumes_Eason_32Archgon_dev_es_boilerplate_lang_zh_index_js" */
  ), cache: true }],
  "en": [{ key: "../lang/en/index.js", load: () => import(
    './_nuxt/index-NW5wu8I-.mjs'
    /* webpackChunkName: "locale__Volumes_Eason_32Archgon_dev_es_boilerplate_lang_en_index_js" */
  ), cache: true }]
};
const vueI18nConfigs = [
  () => import(
    './_nuxt/i18n.config-YgW7ITyi.mjs'
    /* webpackChunkName: "i18n_config_c231e734" */
  )
];
...
const layouts = {
  default: () => import('./_nuxt/default-8JLNLKVa.mjs').then((m) => m.default || m)
};
...
const __nuxt_component_2 = defineComponent({
  ...
  setup(_props, { slots, emit }) {
    ...
    return () => {
      var _a, _b;
      return error2.value ? (_a = slots.error) == null ? void 0 : _a.call(slots, { error: error2, clearError }) : (_b = slots.default) == null ? void 0 : _b.call(slots);
    };
  }
});
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    usePageLoaded();
    const logSomeError = (error2) => {
      console.log("logSomeError", error2);
    };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLayout = __nuxt_component_0;
      const _component_NuxtPage = __nuxt_component_2$1;
      const _component_NuxtErrorBoundary = __nuxt_component_2;
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="loading"><div class="container"><div class="loading__spinner"> FIRST LOADING </div></div></div>`);
      ...
      _push(ssrRenderComponent(_component_NuxtErrorBoundary, { onError: logSomeError }, {
        error: withCtx(({ error: error2 }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>An error occurred: ${ssrInterpolate(error2)}</p>`);
          } else {
            return [
              createVNode("p", null, "An error occurred: " + toDisplayString$1(error2), 1)
            ];
          }
        }),
        _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-8WgE53gE.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-OwEXSBye.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-cpJcCprA.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { __nuxt_component_2$1 as _, parseQuery$1 as a, useRuntimeConfig as b, createError as c, navigateTo as d, entry$1 as default, withoutTrailingSlash$1 as e, usePageLoaded as f, useRoute as g, hasProtocol as h, injectHead as i, joinURL as j, asyncDataDefaults as k, useNuxtApp as l, nuxtLinkDefaults as n, parseURL as p, resolveUnrefHeadInput as r, useRouter as u, withTrailingSlash$1 as w };
