...
const appRootId = "es-app";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"theme-color","content":"#000000"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"copyright","content":"網站開發：ES Design"},{"property":"og:type","content":"website"},{"property":"og:image:width","content":"1200"},{"property":"og:image:height","content":"630"},{"property":"og:image","content":"/socialshare.jpg"},{"property":"twitter:image","content":"/socialshare.jpg"},{"property":"twitter:card","content":"summary_large_image"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"href":"https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@400;700&display=swap","rel":"stylesheet"}],"style":[],"script":[],"noscript":[{"children":"<style>text{position:fixed;top:0;left:0;width:100vw;height:100vh;font-size:2rem;background-color:#000;color:#fff;z-index:10000;display:flex;align-items:center;justify-content:center;text-align:center;padding:5rem}</style>"},{"children":"😓 ES Boilerplate is Awsome：Sorry your JavaScript is off or your browser does not support JavaScript 😓"}],"htmlAttrs":{"lang":"zh-TW"},"charset":"utf-8","titleTemplate":"%s ✷ ES Boilerplate is Awsome"};
